...
対象読者: 日本語環境で 受発注管理システム、営業支援（SFA）を利用する一般ユーザー、承認者、管理者、および経費精算を利用する申請者・承認者・精算担当者
...
| [担当別手順書 一覧](./quick-guides/README.md) | 日常業務ユーザー | 役割別の短い操作手順 |
...
受発注管理システム、経費精算、営業支援（SFA）は、Agentify にログインした後、「マイアプリ」から起動します。
