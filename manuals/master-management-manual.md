...
マスタ情報管理では、各アプリで利用するユーザー、部門、ロール、権限を管理します。
...
- 既存の標準ロール権限が更新されます。
- 標準ロールに手動で追加したテンプレート外の権限は削除されます。
