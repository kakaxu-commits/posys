...
| 状況 | 対応 |
| --- | --- |
| 発注管理がマイアプリに表示されない | Agentify 側のアプリ利用権限を管理者に確認します。 |
| 新規依頼ボタンが表示されない | 購買依頼作成権限を管理者に確認します。 |
| 自分の依頼が一覧に表示されない | 画面を再読み込みします。解決しない場合は管理者へ連絡します。 |
| 承認後の発注状況を確認したい | 購買担当者または承認者へ確認します。 |
